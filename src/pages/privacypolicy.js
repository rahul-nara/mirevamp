                  ...
                  <div className="common-pg-wrap">
                        ...
                        <div className="common-pg-content">
                              ...
                              <ul>
                                    ...
                                    <li>Sharing your personal information: Insights into how and why we share your personal information.</li>
                                    ...
                                    <li>Additional information for residents of the EU, EEA, or UK: Specific details for residents in these regions.</li>
                                    <li>Changes to this notice: How we communicate changes to this Privacy Notice.</li>
                                    <li>Contact us: Information on how to get in touch with us.</li>
                              </ul>
                              <h3>Personal information collection and usage</h3>
                              <h4>Personal Information You Provide Directly</h4>
                              <p>When you reach out to us directly, such as through email correspondence or by completing a form on our website, we gather specific categories of personal information. This may encompass:</p>
                              <ul>
                                    <li>Contact Information: Any personal or contact details you include in your message to us, including but not limited to your name, email address, phone number, and the actual content of your message when using our contact form or sending an email. We solely utilize this information to address your inquiry effectively.</li>
                                    <li>Opt-Out Requests or Corrections: If you choose to exercise your rights to opt out of sharing your personal information, or if you request deletion or correction of your data, we receive relevant personal information from you. This information is exclusively used to fulfill your specific request.</li>
                              </ul>
                              ...
                              <ul>
                                    <li>Site Interactions: We track your activity on our website, such as the pages you visit, links you click, and searches you perform. This helps us understand how people use our site and identify areas for improvement.</li>
                                    <li>Engagement with Content: We track how you interact with content on our site, like watching videos, downloading documents, or commenting on posts. This helps us understand what content is most engaging and tailor it to your needs.</li>
                              </ul>
                              ...
                              <p>For any comments, questions related to this notice, or further insights into our personal information processing practices and your rights concerning your personal information, please reach out to us at:</p>
                        </div>
                  </div>
            </div>
       );
